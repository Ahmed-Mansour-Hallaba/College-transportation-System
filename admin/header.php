        ...
        <div class="collapse navbar-collapse text-center  justify-content-end" id="navbarDarkSupportedContent">
            <form class="form-inline my-2 my-lg-0">
                <ul class="navbar-nav text-right">
                    <li class="nav-item "><a class="nav-link" href="districts.php"> الاحياء <i class="fas fa-road"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="paths.php"> المسارات <i class="fas fa-route"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="trips.php"> الرحلات <i class="fas fa-bus"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="index.php"> التقارير <i class="fas fa-file-invoice"></i></a></li>
                    <li class="nav-item "><a class="nav-link" href="suggest.php"> اقتراحات<i class="far fa-comment-alt"></i></a></li>
                    <li class="nav-item "><span class="nav-link" > مرحبا <?php echo $uarr[1];?> </span></li>
                    <li class="nav-item "><a class="nav-link" href="../logout.php"> تسجيل الخروج <i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
