...
if(!empty($_POST["usertype"]) and $_POST["usertype"]==2&&isset($_POST["uname"])&&isset($_POST["pass"])&&isset($_POST["fname"])&&isset($_POST["mob"])&&isset($_POST["adr"])&&isset($_POST["pmob"]))
{
    $fname=$_POST["fname"];
    $pw=$_POST["pass"];
    $uname=$_POST["uname"];
    ...
    if( mysqli_error($cn))          $_SESSION["error1"]=" حدث خطا بالتسجيل يوجد بيانات مكرره ";
...
else if(isset($_POST["usertype"]) and $_POST["usertype"]==1&&isset($_POST["uname"])&&isset($_POST["pass"])&&isset($_POST["fname"])&&isset($_POST["mob"])&&isset($_POST["busnumber"])&&isset($_POST["color"])&& isset($_POST['cap']))
{
...
else $_SESSION["error1"]=" حدث خطا بالتسجيل يوجد بيانات مكرره ";
header('Location: ' . $_SERVER['HTTP_REFERER']);
