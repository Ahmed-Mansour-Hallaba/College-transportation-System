...
$trslt=mysqli_query($dcn,"select day_no,busnumber,line_name,direction,coll_time,line_id from trips t join buses b on (b.id=t.id) join bus_lines ld on(ld.id=t.line_id) where t.id='$tid'");
