        ...
        <div class="collapse navbar-collapse text-center  justify-content-end" id="navbarDarkSupportedContent">
            <form class="form-inline my-2 my-lg-0">
                <ul class="navbar-nav text-right">
                    <li class="nav-item"><a class="nav-link" href="index.php" > رحلاتي <i class="far fa-calendar-alt"></i></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="apologize.php" > الاعتذار <i class="far fa-calendar-times"></i></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="salary.php" > تقرير مالي  <i class="far fa-money-bill-alt"></i></a>
                    </li>
