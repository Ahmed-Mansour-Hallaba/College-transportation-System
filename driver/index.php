...
$trslt=mysqli_query($pcn,"select t.id,day_no,busnumber,line_name from trips t join buses b on(b.id=t.bus_id) join bus_lines bl on (bl.id=t.line_id) join drivers d on (b.id=d.bus_id) where d.id=$login");
            ...
            <div class="row px-2">
                <div class="col-12 bg-light text-warning text-right rounded p-4 my-3 w-md-50 ">
                    ...
                    <table id="myTable" class="table table-responsive table-bordered table-hover ">
                        ...
                        { ?>
                            <tr>
                                <td><a href="trip_students.php?tid=<?php echo $arr[0]?>">الطالبات</a></td>
